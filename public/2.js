...
var _dashboardPanel = __webpack_require__(820);

var _dashboardPanel2 = _interopRequireDefault(_dashboardPanel);

var _getDashboardData = __webpack_require__(821);

var _getDashboardData2 = _interopRequireDefault(_getDashboardData);
...
var Dashboard = function (_Component) {
    ...
    function Dashboard(props) {
        ...
        _this.getBookings = function () {
            _this.setState({
                bookings: _this.loadBookings()
            });
        };

        _this.loadBookings = function () {
            return _react2.default.createElement(_bookings2.default, null);
        };
    ...
    _createClass(Dashboard, [{
        ...
        key: 'getDashboardPanel',
        value: function getDashboardPanel() {
            var obj = new _getDashboardData2.default(this);
            obj.makeRequest({});
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_dashboardPanel2.default, this.state.dashboardPanle)
                ),
                this.state.bookings
            );
        }
...
exports.default = DashboardPanel;
...
var GetDashboardData = function (_BaseService) {
    _inherits(GetDashboardData, _BaseService);
    ...
    function GetDashboardData() {
        ...
        _classCallCheck(this, GetDashboardData);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = GetDashboardData.__proto__ || Object.getPrototypeOf(GetDashboardData)).call.apply(_ref, [this].concat(args))), _this), _this.requestStr = function () {
            return [];
        }, _this.makeRequest = function (data) {
            _this.api.get('getDashboard').then(function (res) {
                _this.mainObj.setState({ 'dashboardPanle': res.data.response });
                _this.mainObj.getBookings();
            }).catch(function (err) {
                return console.log(err);
            });
        }, _temp), _possibleConstructorReturn(_this, _ret);
